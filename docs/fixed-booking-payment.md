...
- Thanh toán thất bại ghi `PAYMENT_FAILED` và giải phóng tất cả chỗ; khách kiểm tra lại lịch để tạo đơn mới. Hết 15 phút chưa trả tiền ghi `EXPIRED`. Không đổi lỗi thanh toán thành hết hạn trên dashboard hoặc thông báo.
