...
@section('content')
    <header class="auth-heading"><small>XÁC THỰC TÀI KHOẢN</small>
        <h2>Xác thực Email</h2>
        <p>Chúng tôi đã gửi một liên kết xác thực đến <strong>{{ auth()->user()->email }}</strong>.</p>
    </header>
    <p class="auth-verify-hint"><i class="bi bi-envelope-check"></i> Vui lòng kiểm tra hộp thư đến và nhấn vào liên kết xác
        thực để kích hoạt tài khoản.</p>
    @if(session('success'))
